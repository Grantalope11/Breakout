...
set rc [catch {
  ...
  catch { report_clock_utilization -file RAT_wrapper_clock_utilization_placed.rpt }
...
set rc [catch {
  ...
  catch { report_drc -file RAT_wrapper_drc_routed.rpt -pb RAT_wrapper_drc_routed.pb }
  ...
  catch { report_power -file RAT_wrapper_power_routed.rpt -pb RAT_wrapper_power_summary_routed.pb }
